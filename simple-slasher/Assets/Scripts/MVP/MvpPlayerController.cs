...
public class MvpPlayerController : MonoBehaviour
{
    [Header("Movement")]
    ...
    private MvpPlayerCombat combat;
    private MvpPlayerHealth playerHealth;

    public void Initialize(MvpRageSystem rage, MvpPlayerCombat combatRef, MvpPlayerHealth health)
    {
        rageSystem = rage;
        combat = combatRef;
        playerHealth = health;
